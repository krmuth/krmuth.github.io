...
*The following was generated by Claude Sonnet 4.6 (extended). Prompt: Identify every instance of ambiguity in this text, using William Empson's seven types as a guide for what counts as ambiguous language. Where 'this text' is the last ~10,750 characters of the novel. NB that instances of 'San Francisco' in place of 'San Narciso' are artefacts of errors in the original .txt file.*
